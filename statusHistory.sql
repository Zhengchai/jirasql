select to_char(changegroup.created, 'YYYY-MM-DD'),to_char(j.created, 'YY"wk"WW'),:'LOG',concat(project.pkey,'-',j.issuenum),priority.pname,j.assignee,concat(oldstatus.pname,'->',newstatus.pname)
